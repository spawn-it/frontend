// Données pour les catégories de services
export const categories = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'keycloak', name: 'Keycloak', image: 'https://wangler.io/content/images/size/w960/2022/05/keycloak.jpeg' },
        { id: 'drupal', name: 'Drupal', image: 'https://cdn.stackoverflow.co/images/jo7n4k8s/production/989197bbd274de342caf84c3642d8c6bc7b980ea-1920x700.png?rect=294,0,1333,700&w=1200&h=630&auto=format&dpr=2' }
      ]
    },
    {
      id: 'devtools',
      name: 'Dev Tools',
      items: [
        { id: 'gitlab', name: 'GitLab', image: 'https://btech.id/media/images/Page/2024/02/28/GitLab-logo-2709954696.png' },
